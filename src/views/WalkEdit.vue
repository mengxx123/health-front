<template>
    <my-page title="添加步行记录" :page="page" backable>
        <div class="common-container">
            <div>
                <ui-text-field v-model.number="distance" label="距离（km）" hintText=""/>
            </div>
            <div>
                <ui-text-field v-model.number="minute" type="number" label="分钟" hintText=""/>
            </div>
            <div>
                <ui-text-field v-model.number="secodn" type="number" label="秒" hintText=""/>
            </div>
            <div class="btns">
